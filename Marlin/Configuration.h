...
// Lite6 uses this guy according to https://e3d-online.dozuki.com/Guide/Lite6+Marlin+Configuration/27?lang=en
...
#define EXTRUDE_MAXLENGTH 450 // 450 is how much we need to load/unload
...
// Enable the M48 repeatability test to test probe accuracy. Disable to save PROGMEM.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  /**
   * Enable the G26 Mesh Validation Pattern tool. Disable to save PROGMEM.
   */
  //#define G26_MESH_VALIDATION
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.3  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2  // (mm) Default layer height for the G26 Mesh Validation Tool.
    #define MESH_TEST_HOTEND_TEMP  175.0  // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
